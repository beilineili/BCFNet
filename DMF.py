...
def get_model(train, num_users, num_items, userlayers, itemlayers):
    ...
    # DMF part
    userlayer = Dense(userlayers[0],
                      activation="linear",
                      name='dmf_user_embedding')
    itemlayer = Dense(itemlayers[0],
                      activation="linear",
    ...
    #attention
    attention_user = Dense(userlayers[0],
                           activation='softmax',
                           name='attention_user')(user_latent_vector)
    user_latent_vector2 = multiply([user_latent_vector, attention_user],
                                   name='attention_user_mul')
    user_latent_vector2 = concatenate(
        [user_latent_vector, user_latent_vector2])

    attention_item = Dense(itemlayers[0],
                           activation='softmax',
                           name='attention_item')(item_latent_vector)
    item_latent_vector2 = multiply([item_latent_vector, attention_item],
                                   name='attention_item_mul')
    item_latent_vector2 = concatenate(
        [item_latent_vector, item_latent_vector2])
    ...
    for idx in range(1, num_layer):
        ...
        user_latent_vector2 = userlayer(user_latent_vector2)
        item_latent_vector2 = itemlayer(item_latent_vector2)

    predict_vector = multiply([user_latent_vector2, item_latent_vector2])
    prediction = Dense(1,
                       activation='sigmoid',
